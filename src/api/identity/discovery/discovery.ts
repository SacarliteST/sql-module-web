 ...
 */
export const jwks = async ( options?: Parameters<typeof identityFetch>[1]): Promise<jwksResponse> => {
 ...
 */
export const openIdConfiguration = async ( options?: Parameters<typeof identityFetch>[1]): Promise<openIdConfigurationResponse> => {
